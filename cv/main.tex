...
\cventry{2024}{Amazon (AWS AI), Santa Clara, CA}{Applied Scientist Intern}{}{}{Developed large language models (LLMs) based on state-space models (SSMs) to perform code generation and constrained generation}
...
\cvitem{Sept. 2024}{\textit{Prospective Learning: Learning for a Dynamic Future}, NeurIPS 2024 workshop on NeurIPS Workshop on NeuroAI: Fusing Neuroscience and AI for Intelligent Solutions, Vancouver, Canada}

...
\cventry{2024}{Amazon, Santa Clara, CA}{Applied Scientist Intern}{}{}{Developed large language models (LLMs) based on state-space models (SSMs) to perform code generation and constrained generation}

...
Ph.D. candidate in Biomedical Engineering with expertise in statistical machine learning and deep learning, focused on developing theory and robust methods for out-of-distribution generalization and continual learning. Passionate about bridging artificial and natural intelligence. My work spans applications in large language models, biomedical data, and computer vision.
...
\cventry{Summer 2025}{Amazon (AWS AI), Santa Clara, CA}{Applied Scientist Intern}{}{}{Memory management for multi-turn tool-using agents}

...
\newenvironment{twocolentry}[2][]{
    ...
    \switchcolumn \raggedleft \secondColumn\strut
    \end{paracol}
    \endonecolentry
...
\begin{document}
    ...
    \section{Education}
        ...
        \begin{threecolentry}{Ph.D.}{Aug 2021 -- May 2026}
    ...
    \section{Research Experience}
        ...
        \begin{twocolentry}{Aug 2021 – May 2026}
        ...
        \begin{onecolentry}
            \begin{highlights}
                ...
                \item Presented this work at top machine learning conferences, workshops, and journals (including NeurIPS, ICML, and TMLR), and won two best paper awards at AGI'25 and the ECCV'22 workshop on OOD generalization in computer vision.
            \end{highlights}
        \end{onecolentry}
    ...
    \begin{onecolentry}
        \begin{highlights}
            \item \textbf{Machine Learning}: Supervised/Unsupervised/Self-supervised Learning, Generative Modeling, Continual Learning, Domain Adaptation, Transfer Learning, Computer Vision, Reinforcement Learning, Time-series Forecasting
            \item \textbf{Deep Learning}: Large Language Models (LLMs), Vision-Language Models (VLMs), Diffusion Models, GANs, VAEs, State-Space Models (S4, Mamba, etc.)
            \item \textbf{Large Language Models}: Pre-training, Fine-tuning (LoRA, DPO, PPO, GRPO), Retrieval-Augmented Generation (RAG), LLM Agents
            \item \textbf{Signal Processing}: Kalman Filtering, Sparse Recovery, Compressed Sensing, Filter Design
            \item \textbf{Programming}: Python, MATLAB, R, C++
            \item \textbf{Libraries}: PyTorch, HuggingFace, vLLM, LangChain, Chroma, Scikit-learn, TensorFlow, Pandas, OpenCV, Weights \& Biases, Hydra
    ...
    \begin{onecolentry}
        \begin{highlights}  
            ...
            \item \textbf{Second runner-up, IEEE Video and Image Processing Cup} -- International Conference on Image Processing (ICIP) 2021, Anchorage, Alaska, USA (2021)
    ...
    \begin{onecolentry}
        \begin{highlights}
            \item \textbf{Reviewer}: NeurIPS (2025, 2026), Conference on Language Models (COLM) (2025, 2026), Moratuwa Engineering Research Conference (MERCon) (2024, 2025, 2026)
        \end{highlights}
    \end{onecolentry}
    ...
    \textbf{Panelist} | JHU BME PhD Retreat | Baltimore, MD
    \end{twocolentry}
    \vspace{0.10 cm}
    \begin{onecolentry}
        \begin{highlights}
            \item Invited panelist discussing graduate research, navigating the PhD program, and academic and career development with first-year Biomedical Engineering PhD students.
        \end{highlights}
    \end{onecolentry}
    ...
    \begin{twocolentry}{2026}
    \textbf{Panelist} | Summer Internship Program (SIP), JHU School of Medicine | Baltimore, MD
    \end{twocolentry}
    \vspace{0.10 cm}
    \begin{onecolentry}
        \begin{highlights}
            \item Invited panelist sharing research experiences, graduate school insights, and career advice with graduate students participating in the School of Medicine Summer Internship Program.
        \end{highlights}
    \end{onecolentry}
